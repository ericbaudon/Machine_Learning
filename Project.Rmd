...
author: "Eric BAUDON"
---
In this report we are going to explain how we build our prediction model using the Train and Test data available for the activity.
...
Clearly **Random Forest** is our best model with an accuracy around **99%**. We are going to use this model as our define machine learning model.
